	...
	public class UnitTest1
	{
		...
		*/
		...
		public void Indicates_Selected_Category()
		{
			...
			NavViewComponent target = new(mock.Object);

			// Arrange - define the category to selected
			string categoryToSelect = "Apples";

			// Action
			var result = (ViewViewComponentResult)target.Invoke(categoryToSelect);
			var selectedCategory = result.ViewData["SelectedCategory"];
